 ...
 * @author BigEma
 */
public class NewWinLoseWindow extends javax.swing.JFrame implements ActionListener {
    private FlooditMainGui father;

    /** Creates new form NewWinLoseWindow */
    public NewWinLoseWindow(boolean win, int steps) {
        initComponents();
        if (win) {
            this.image.setIcon(new ImageIcon("ganaste120x120.jpg"));
        } else {
            this.image.setIcon(new ImageIcon("perdiste120x120.jpg"));
        }
        this.image.setText("");
    ...
    private void initComponents() {
        ...
        stepsNumber.setFont(new java.awt.Font("Segoe Print", 3, 24)); // NOI18N
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource() == okButon) {
            NewWinLoseWindow.this.okButonActionPerformed(evt);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new NewWinLoseWindow(false,25).setVisible(true);
            }
        });
    }
